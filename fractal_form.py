...
"}")
        ...
        self.menuGallery_G = QtWidgets.QMenu(self.menuBar)
        self.menuGallery_G.setObjectName("menuGallery_G")
        ...
        self.Frost = QtWidgets.QAction(MainWindow)
        self.Frost.setObjectName("Frost")
        self.Ameba = QtWidgets.QAction(MainWindow)
        self.Ameba.setObjectName("Ameba")
        self.Flower = QtWidgets.QAction(MainWindow)
        self.Flower.setObjectName("Flower")
        self.Suraj = QtWidgets.QAction(MainWindow)
        self.Suraj.setObjectName("Suraj")
        self.Healing = QtWidgets.QAction(MainWindow)
        self.Healing.setObjectName("Healing")
        self.Mandel = QtWidgets.QAction(MainWindow)
        self.Mandel.setObjectName("Mandel")
        self.Whirling = QtWidgets.QAction(MainWindow)
        self.Whirling.setObjectName("Whirling")
        self.Poison = QtWidgets.QAction(MainWindow)
        self.Poison.setObjectName("Poison")
        self.Autumn = QtWidgets.QAction(MainWindow)
        ...
        self.menuGallery_G.addAction(self.Frost)
        self.menuGallery_G.addAction(self.Ameba)
        self.menuGallery_G.addAction(self.Flower)
        self.menuGallery_G.addAction(self.Suraj)
        self.menuGallery_G.addAction(self.Poison)
        self.menuGallery_G.addAction(self.Healing)
        self.menuGallery_G.addSeparator()
        self.menuGallery_G.addAction(self.Whirling)
        self.menuGallery_G.addAction(self.Mandel)
        self.menuGallery_G.addAction(self.Autumn)
        self.menuBar.addAction(self.menu_F.menuAction())
        self.menuBar.addAction(self.menuGallery_G.menuAction())
        ...
        self.Frost.triggered.connect(MainWindow.load_mandel_csv)
        self.Ameba.triggered.connect(MainWindow.load_mandel_csv)
        self.Flower.triggered.connect(MainWindow.load_mandel_csv)
        self.Suraj.triggered.connect(MainWindow.load_mandel_csv)
        self.Healing.triggered.connect(MainWindow.load_mandel_csv)
        self.Mandel.triggered.connect(MainWindow.load_julia_csv)
        self.Whirling.triggered.connect(MainWindow.load_julia_csv)
        self.Poison.triggered.connect(MainWindow.load_mandel_csv)
        self.Autumn.triggered.connect(MainWindow.load_julia_csv)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.menuGallery_G.setTitle(_translate("MainWindow", "Gallery(&G)"))
        ...
        self.Frost.setText(_translate("MainWindow", "Frost"))
        self.Ameba.setText(_translate("MainWindow", "Ameba"))
        self.Flower.setText(_translate("MainWindow", "Flower"))
        self.Suraj.setText(_translate("MainWindow", "Suraj"))
        self.Healing.setText(_translate("MainWindow", "Healing"))
        self.Mandel.setText(_translate("MainWindow", "Mandel"))
        self.Whirling.setText(_translate("MainWindow", "Whirling"))
