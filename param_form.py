...
class Ui_SubWindow(object):
    def setupUi(self, SubWindow):
        ...
        SubWindow.setMinimumSize(QtCore.QSize(0, 0))
        SubWindow.setMaximumSize(QtCore.QSize(16777215, 16777215))
        font = QtGui.QFont()
...
"}")
        ...
        self.param_tab.setGeometry(QtCore.QRect(0, 0, 390, 340))
...
"}")
        ...
        self.brightBox.raise_()
        self.hueSlider.raise_()
        self.colorbar.raise_()
        self.hueText.raise_()
        self.chromaText.raise_()
        self.chromaSlider.raise_()
